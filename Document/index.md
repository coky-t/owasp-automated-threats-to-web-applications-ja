...
OWASP Automated Threats to Web Applications Project の簡潔な概要を紹介する動画 "Automated Threats - Web's Hidden Puppeteers" をご覧ください。
...
* [OAT-003 コストインフレ詐欺 (Cost-Inflation Fraud)](assets/oats/JA/OAT-003_Cost-Inflation_Fraud.md)
...
どれがどれかわからない？ [脅威識別チャート](https://raw.githubusercontent.com/OWASP/www-project-automated-threats-to-web-applications/refs/heads/master/assets/files/oat-ontology-decision-chart.pdf) と [ハンドブック全体](https://github.com/OWASP/www-project-automated-threats-to-web-applications/tree/master/assets/files/EN) を併用してください。

私たちはすべての OAT をまとめたポスター "The Web's Unwanted Bad Bots" も作成しました。

![The Web's Unwanted Bad Bots](assets/images/oat-poster-1v3-3.png)

このポスターは [PDF](https://raw.githubusercontent.com/OWASP/www-project-automated-threats-to-web-applications/refs/heads/master/assets/files/oat-poster-1v3-3.pdf) でも入手可能です。
